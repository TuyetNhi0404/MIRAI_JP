import { Facebook, Instagram, Pin, Mail, BookOpen, School, Users as Groups } from 'lucide-react';
...
const MiraiJpCenter: React.FC = () => {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif" }}>
      <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,900;1,900&family=Inter:wght@400;600;700&display=swap" rel="stylesheet" />
      <style>{`
        .seigaiha {
      ...
      <nav style={{
        ...
        {!isMobile && (
          <div style={{ display: 'flex', gap: '30px', alignItems: 'center' }}>
            <a href="#courses" style={{ color: '#1A1A1A', textDecoration: 'none', fontSize: '14px', fontWeight: '600' }}>KHÓA HỌC</a>
            <a href="#about" style={{ color: '#1A1A1A', textDecoration: 'none', fontSize: '14px', fontWeight: '600' }}>VỀ CHÚNG TÔI</a>
            <a href="#gallery" style={{ color: '#1A1A1A', textDecoration: 'none', fontSize: '14px', fontWeight: '600' }}>CỘNG ĐỒNG</a>
            <a href="#contact" style={{ color: '#1A1A1A', textDecoration: 'none', fontSize: '14px', fontWeight: '600' }}>TÀI NGUYÊN</a>
          </div>
        )}
      ...
      {!isMobile && (
        <div style={{
          ...
          <a href="https://www.facebook.com/fsoftacademy.dn" style={{ color: '#B90000', textDecoration: 'none' }}>
            <Facebook size={20} />
          </a>
          <a href="https://www.instagram.com/fptsoftwareacademy?igsh=MXIzOTdycmxraTJodw==" style={{ color: '#B90000', textDecoration: 'none' }}>
            <Instagram size={20} />
          </a>
        </div>
      )}
      ...
      {/* Hero Section */}
      <section id="home" className="seigaiha" style={{
        marginTop: '80px',
        display: 'flex',
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Chinh Phục Tiếng Nhật <br /> Cùng <span style={{ color: '#B90000', fontStyle: 'italic' }}>MIRAI</span>
          </h1>
          <p style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ color: '#FFD700', fontSize: '20px', marginBottom: '5px' }}>★★★★★</div>
            <div style={{ fontWeight: 'bold', fontSize: '18px' }}>5,000+ Học viên</div>
            <div style={{ fontSize: '12px', color: '#666' }}>Đã tin tưởng MIRAI</div>
          </div>
        </div>
      </section>

      {/* Why Choose Section */}
      <section className="seigaiha" style={{
        ...
        <div style={{
          ...
          {[
            ...
            <div key={idx} style={{
              ...
              <h3 style={{ fontWeight: 'bold', fontSize: '20px', marginBottom: '15px' }}>{item.title}</h3>
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{
              ...
              Hệ thống quản lý trung tâm dạy tiếng Nhật Mirai là một website hỗ trợ toàn diện cho hoạt động quản lý và giảng dạy tại trung tâm Nhật ngữ. Với giao diện hiện đại và thân thiện, Mirai giúp kết nối giữa quản trị viên, giảng viên và học viên trên cùng một nền tảng, từ đó tối ưu hóa quy trình vận hành và nâng cao chất lượng đào tạo. Hệ thống hỗ trợ quản lý khóa học, lớp học, lịch học, điểm danh, kết quả học tập cũng như theo dõi tiến độ của từng học viên một cách hiệu quả.
              {showFullAbout && (
                <span> Hệ thống cung cấp công cụ mạnh mẽ để quản lý lớp học, sắp xếp lịch học, điểm danh tự động và theo dõi kết quả học tập của từng học viên. Với Mirai, trung tâm có thể dễ dàng quản lý thông tin học viên, giao bài tập, tổ chức kỳ thi và đưa ra đánh giá chính xác. Các tính năng này giúp giảm tải công việc hành chính, tiết kiệm thời gian và nâng cao hiệu quả giảng dạy. Ngoài ra, hệ thống còn hỗ trợ báo cáo, thống kê và phân tích dữ liệu để giúp quản trị viên đưa ra quyết định chiến lược, tối ưu hóa hoạt động và phát triển trung tâm một cách bền vững.</span>
              )}
            </p>
            <button
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: '#AAA', lineHeight: '1.8', marginBottom: '30px' }}>
              Kiến tạo tương lai cùng ngôn ngữ và văn hóa Nhật Bản. Trải nghiệm học tập đẳng cấp, hiệu quả và hiện đại nhất.
            </p>
          ...
          {/* Links 1 */}
          <div>
            <h4 style={{ fontWeight: 'bold', marginBottom: '25px' }}>Khóa học</h4>
            <ul style={{ listStyle: 'none', padding: 0, color: '#AAA', lineHeight: '2.5' }}>
          ...
          {/* Newsletter */}
          <div>
            <h4 style={{ fontWeight: 'bold', marginBottom: '25px' }}>Bản tin</h4>
            <p style={{ color: '#AAA', marginBottom: '20px' }}>Nhận thông tin về các lớp học và sự kiện mới nhất.</p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '20px' }}>
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); /* handle login */ }} style={{ color: '#B90000', textDecoration: 'none', fontWeight: 'bold' }}>Đăng nhập ngay</a>
          </div>
        </div>
      </footer>
